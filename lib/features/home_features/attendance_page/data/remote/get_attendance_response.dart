class GetAttendanceResponse {
  ...
  GetAttendanceResponse(
      {this.status, this.code, this.message, required this.data});
...
class AttendanceData {
  ...
  AttendanceData(
      ...
      this.notesCheckIn,
      this.notesCheckOut,
      this.imagePathCheckIn,
      this.createdAt,
      this.updatedAt,
      this.createdBy,
      this.updatedBy,
      this.photoNamesCheckIn,
      this.photoNamesCheckOut,
      this.imagePathCheckOut,
  ...
  AttendanceData.fromJson(Map<String, dynamic> json) {
    ...
    if (json["check_in"] is String) this.checkIn = json["check_in"];
    if (json["check_out"] is String) this.checkOut = json["check_out"];
    if (json["location_check_in"] is String)
      this.locationCheckIn = json["location_check_in"];
    if (json["notes_check_in"] is String)
      this.notesCheckIn = json["notes_check_in"];
    if (json["notes_check_out"] is String)
      this.notesCheckOut = json["notes_check_out"];
    ...
    if (json["user_name"] is String) this.userName = json["user_name"];
  ...
  Map<String, dynamic> toJson() {
    ...
    data["notes_check_in"] = this.notesCheckIn;
    data["notes_check_out"] = this.notesCheckOut;
