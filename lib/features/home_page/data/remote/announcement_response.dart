...
class AnnouncementResponse {
  ...
  AnnouncementResponse.fromJson(Map<String, dynamic> json) {
    ...
    if(json["data"] is List)
      this.data = json["data"]==null ? null : (json["data"] as List).map((e)=>DataAnnouncements.fromJson(e)).toList();
  }
...
class DataAnnouncements {
  ...
  DataAnnouncements({this.id, this.companyId, this.departmentId, this.title, this.subtitle, this.url, this.imgUrl, this.expiredAt});

  DataAnnouncements.fromJson(Map<String, dynamic> json) {
    if(json["id"] is int)
      this.id = json["id"];
