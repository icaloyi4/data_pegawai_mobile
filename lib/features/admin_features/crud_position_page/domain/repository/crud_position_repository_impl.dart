...
import '../../data/local/crud_position_local_source.dart';
import '../../data/remote/crud_position_remote_source.dart';
import 'crud_position_repository.dart';

class CrudPositionRepositoryImpl implements CrudPositionRepository {
  final CrudPositionRemoteSource _remoteSource;
  final CrudPositionLocalSource _localSource;

  CrudPositionRepositoryImpl(this._remoteSource, this._localSource);
